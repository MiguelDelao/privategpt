...
from .admin import get_current_settings, get_selected_model
...
# Use get_selected_model from admin module (imported above)
...
async def _generate_llm_response(
    ...
    try:
        ...
        # Get selected model from centralized config
...
async def list_available_models():
    ...
    try:
        ...
        # Get currently selected model from centralized config
