...
from config_loader import get_service_url, get_app_info
...
WORKFLOW_ENGINE = "n8n"
VERSION_INFO = f"Version {app_info['version']} - Polished Interface"

# Configuration from centralized config
AUTH_SERVICE_URL = get_service_url("auth")
KNOWLEDGE_SERVICE_URL = get_service_url("knowledge")
